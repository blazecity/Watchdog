...
namespace Watchdog.Forms.Settings
{
    ...
    public partial class FormSettings : Window
    {
        ...
        public FormSettings()
        {
            ...
            {
                { "trvItemAssetClasses", () => new UserControlAssetClasses()},
                { "trvItemCurrencies", () => new UserControlAssetClasses() },
                { "trvItemRatingAgencies", () => new UserControlAssetClasses() },
                { "trvItemDurations", () => new UserControlAssetClasses() }
            };
